...
<head>
    ...
    <link rel="stylesheet" href="../../../css/proyecto_navbar.css" />
...
<body>
    ...
    <div class="container">
        ...
        <div class="intro">
            <img src="../../../imagenes/proyecto1.png" class="img" alt="Domos Arquitectos" />
            <div class="intro-text">
                <p>
                <h3>VIVIENDA UNIFAMILIAR LAS PALMERAS</h2>
                    <p>Diseño: Domos Arquitectos</p>
                    <p>Área: 180,00 m²</p>
                    <p>Ubicacion: Ica</p>
                    </p>
            </div>
        ...
        <div class="intro">
            <img src="../../../imagenes/proyecto2.png" class="img" alt="Domos Arquitectos" />
            <div class="intro-text">
                <p>
                <h3>EDIFICIO MULTIFAMILIAR MIXTO (VIIENDA / COMERCIO) AYABACA</h2>
                    <p>Diseño: Domos Arquitectos</p>
                    <p>Área: 500,00 m²</p>
                    <p>Ubicacion: Ica</p>
                    </p>
        ...
        <div class="intro">
            <img src="../../../imagenes/proyecto3.png" class="img" alt="Domos Arquitectos" />
            <div class="intro-text">
                <p>
                <h3>VIVIENDA UNIFAMILIAR CONDOMINIO LA FLORIDA PARCONA</h2>
                    <p>Diseño: Domos Arquitectos</p>
                    <p>Área: 120,00 m²</p>
                    <p>Ubicacion: Ica</p>
                    </p>
        ...
        <div class="intro">
            <img src="../../imagenes/proyecto4.png" class="img" alt="Domos Arquitectos" />
            <div class="intro-text">
                <p>
                <h3>VIVIENDA UNIFAMILIAR - LOS AQUIJES</h2>
                    <p>Diseño: Domos Arquitectos</p>
                    <p>Área: 110,00 m²</p>
                    <p>Ubicacion: Ica</p>
                    </p>
