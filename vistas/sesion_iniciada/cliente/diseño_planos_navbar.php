...
<head>
    ...
    <link rel="stylesheet" href="../../../css/diseño_planos_navbar.css" />
    <title>Diseño de planos</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="nosotros">
            <h1>Diseño de planos</h1>
        </div>
        <div class="intro">
            <img src="../../../imagenes/diseño_planos.png" class="img" alt="Domos Arquitectos" />
            <div class="intro-text">
                <p>
                <p>✔Desarrollo de Anteproyecto arquitectónico.</p>
                <p>✔Desarrollo de planos eléctronicos, estructurales y sanitarios.</p>
                <p>✔Diseño de planos de distribución y planos detallados.</p>
                <p>✔Diseño de planos para desarrollos urbanísticos.</p>
                <p>✔Diseño de edificios institucionales.</p>
                <p>✔Diseño arquitectónico residencial.</p>
                </p>
            </div>
        </div>
        <!--footer-->
