...
<head>
    ...
    <link rel="stylesheet" href="../../../css/diseño_edificios_navbar.css" />
    <title>Diseño de edificos multifamiliares</title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="nosotros">
            <h1>Diseño de edificios multifamiliares</h1>
        </div>
        <div class="intro">
            <img src="../../../imagenes/diseño_edificos.png" class="img" alt="Domos Arquitectos" />
            <div class="intro-text">
                <p>
                <p>✔Elaboración de cabidas arquitectónicas.</p>
                <p>✔Diseño de mobiliario de acuerdo a sus necesidades.</p>
                <p>✔Desarrollo de edificios unifamiliares y multifamiliares.</p>
                <p>✔Diseño para condominios residenciales.</p>
                <p>✔Diseño para proyectos de vivienda intergeneracional.</p>
                </p>
            </div>
        </div>
        <!--footer-->
